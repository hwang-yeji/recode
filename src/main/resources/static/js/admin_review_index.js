$(function() {
        ...
        $.ajax({
            ...
            success : function(data) {
                if (data == "delete") {
                    ...
                    location.href = "/admin/review/index?isDel=0&page=" + url.get("page") + "&category=" + url.get("category") + "&searchKeyword=" + url.get("searchKeyword");
                }
            }
        });
    });
    ...
    if(url.get("page") == null && url.get("category") == null && url.get("searchKeyword") == null) {
        history.pushState(null, null, "/admin/review/index?page=0&category=0&searchKeyword=");
    }
